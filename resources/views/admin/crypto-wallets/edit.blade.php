...
@section('title', 'Edit Crypto Wallet')
@section('page-title', 'Edit Crypto Wallet: ' . $cryptoWallet->name)
...
@section('page-actions')
    <div class="btn-group">
        ...
        <a href="{{ route('admin.crypto-wallets.show', $cryptoWallet) }}" class="btn btn-info">
...
@section('content')
<form action="{{ route('admin.crypto-wallets.update', $cryptoWallet) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                       id="name" name="name" value="{{ old('name', $cryptoWallet->name) }}" required
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('slug') is-invalid @enderror"
                                       id="slug" name="slug" value="{{ old('slug', $cryptoWallet->slug) }}"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('wallet_address') is-invalid @enderror"
                                  ...
                                  required>{{ old('wallet_address', $cryptoWallet->wallet_address) }}</textarea>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('instructions') is-invalid @enderror"
                                  ...
                                  placeholder="e.g., Send only USDT via TRC20 network. Minimum deposit $50.">{{ old('instructions', $cryptoWallet->instructions) }}</textarea>
                        @error('instructions')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                   value="1"
                                   {{ old('is_active', $cryptoWallet->is_active) ? 'checked' : '' }}>
                ...
                <div class="card-body">
                    @if($cryptoWallet->wallet_image)
                        <div class="text-center mb-3">
                            <img src="{{ $cryptoWallet->wallet_image_url }}" alt="Current wallet image"
                                 style="max-height: 120px; max-width: 100%; border-radius: 8px; border: 1px solid #404040; background: #fff;">
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    @if($cryptoWallet->qr_code_image)
                        <div class="text-center mb-3">
                            <img src="{{ $cryptoWallet->qr_code_image_url }}" alt="Current QR code"
                                 style="max-height: 120px; max-width: 100%; border-radius: 8px; border: 1px solid #404040; background: #fff;">
                            <p class="text-muted small mt-1">Current QR code. Upload a new one to replace it.</p>
                        </div>
                    @endif
                    <div class="mb-3">
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Update Crypto Wallet
                        </button>
                    </div>
                </div>
            </div>
