        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h3 class="card-title mb-0">Create New Booking</h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('event_description') is-invalid @enderror" 
                                      ...
                                      placeholder="Describe the event, type of performance needed, audience size, etc.">{{ old('event_description') }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('special_requests') is-invalid @enderror" 
                                      ...
                                      placeholder="Any special requirements or requests from the customer">{{ old('special_requests') }}</textarea>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea class="form-control @error('admin_notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Internal notes for admin reference">{{ old('admin_notes') }}</textarea>
                            @error('admin_notes')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
