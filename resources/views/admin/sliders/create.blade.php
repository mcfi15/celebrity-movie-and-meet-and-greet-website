                    ...
                    <div class="row">
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <div class="image-upload-container">
                                ...
                                <div class="form-text text-white">
                                    ...
                                    Recommended size: 1920x1080px (16:9 ratio). Maximum file size: 5MB.
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('subtitle') is-invalid @enderror" 
                                   id="subtitle" name="subtitle" value="{{ old('subtitle') }}" maxlength="255">
                            @error('subtitle')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" 
                                      ...
                                      placeholder="Optional description for the slider...">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" class="form-control @error('order_position') is-invalid @enderror" 
                                   id="order_position" name="order_position" value="{{ old('order_position') }}" 
                                   min="0" placeholder="Auto-generated if left empty">
                            @error('order_position')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                            <div class="form-text text-white">Lower numbers appear first. Leave empty to add at the end.</div>
                        </div>
